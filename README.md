...
[Back to Contents](#contents)  
It's an online pub quiz that can be played solo or with multiple players and teams. It comprises categorized
...
connects with the <https://opentdb.com/> API to populate the questions. Each request to the API for
...
the About page.
* **Wireframes**  
-- [Desktop](001_index_desktop.png)  
-- [Tablet](001_index_tablet.png)  
-- [Mobile](001_index_mobile.png)  
...
* **Wireframes**  
-- [Desktop](001_about_desktop.png)  
-- [Tablet](001_about_tablet.png)  
-- [Mobile](001_about_mobile.png)  
...
* **Wireframes**  
-- [Desktop](001_register_desktop.png)  
-- [Tablet](001_register_tablet.png)  
-- [Mobile](001_register_mobile.png)  
...
* **Wireframes**  
-- [Desktop](001_login_desktop.png)  
-- [Tablet](001_login_tablet.png)  
-- [Mobile](001_login_mobile.png)  
...
players. 
* **Wireframes**  
-- [Desktop](001_profile_desktop.png)  
-- [Tablet](001_profile_tablet.png)  
-- [Mobile](001_profile_mobile.png)  
...
* **Wireframes**  
-- [Desktop](001_create_desktop.png)  
-- [Tablet](001_create_tablet.png)  
-- [Mobile](001_create_mobile.png)  
...
collapsible card.
* **Wireframes**  
-- [Desktop](001_quiz_admin_desktop.png)  
-- [Tablet](001_quiz_admin_tablet.png)  
-- [Mobile](001_quiz_admin_mobile.png)  
...
* **Wireframes**  
-- [Desktop](001_quiz_admin_rounds_desktop.png)  
-- [Tablet](001_quiz_admin_rounds_tablet.png)  
-- [Mobile](001_quiz_admin_rounds_mobile.png)  
...
* **Wireframes**  
-- [Desktop](001_quiz_admin_details_desktop.png)  
-- [Tablet](001_quiz_admin_details_tablet.png)  
-- [Mobile](001_quiz_admin_details_mobile.png)  
...
## **4.2 Heroku**
The site is deployed via Heroku with the puiblished version being visible on <https://mongo-quiz.herokuapp.com>.

In order to achive this and to keep it up to date, each "push" to Github is automatically added to Heroku. In
addition, the data contained in the env.py file is mirrored in the Heroku "Config Vars" section within settings.
...
### **6.1 MongoDb**
The database employed for storing User and Quiz data is MongoDB, accessible at
